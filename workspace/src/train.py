...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=False, scheduler_type = "plateau"):
    ...
    #scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max = n_epochs, eta_min=0.0, last_epoch=-1)
